      ...
      >
        <div className="text-center space-y-6 max-w-4xl mx-auto">
          <div className="inline-block relative transform hover:scale-105 transition-all duration-500 mb-6">
            ...
            <div className="relative px-6 py-2 text-sm font-medium bg-background/80 border border-primary/30 backdrop-blur-sm text-primary rounded-full">
              <div className="flex items-center space-x-2">
                ...
                <span>
                  I'm a <TypeWriterEffect roles={roles} />
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-tight md:leading-tight lg:leading-tight">
            <span
              className="block mb-2 animate-fade-in opacity-0"
            ...
            <div className="relative inline-block">
              <span
                className="relative z-10 text-gradient animate-fade-in opacity-0"
                style={{
                  animationDelay: "0.9s",
              ...
              <div
                className="absolute -inset-1 bg-gradient-to-r from-primary/20 via-purple-500/20 to-indigo-500/20 blur-lg -z-10 opacity-0 group-hover:opacity-100 animate-fade-in"
                style={{
                  animationDelay: "1.2s",
                  animationFillMode: "forwards",
                }}
          ...
          >
            Crafting elegant digital experiences where code meets creativity. I
            specialize in modern web technologies and AI integration to build
